...
public class MacTest {
    public static void main(String[] args) {
        try {
            String s = "0200199559993500000000002000000000000010000070616032100392470110008010200020801020002F4112345F42012345678912";
            System.out.println(s.length());

            //密钥
            String kkey = "0123456789ABCDEFFEDCBA9876543210";
            //待加密数据
            String data = "0200199559993500000000002000000000000010000070616032100392470110008010200020801020002F4112345F42012345678912";
            //POS终端MAC值
